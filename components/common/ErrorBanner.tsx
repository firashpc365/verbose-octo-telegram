...
export const ErrorBanner: React.FC<ErrorBannerProps> = ({ message, clearError }) => {
  ...
  return (
    <div className={`fixed top-5 left-1/2 -translate-x-1/2 z-50 transition-all duration-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
        {message && (
            <div className="max-w-sm w-full alert alert-error px-4 py-3 rounded-xl shadow-lg flex justify-between items-center">
